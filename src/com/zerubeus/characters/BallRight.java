...
public class BallRight {
	...
	private String name;
		...
		private BufferedImage[] standing_normal = {Sprite.getSprite(0, 7), Sprite.getSprite(1, 7), Sprite.getSprite(2, 7)};	
	...
	public BallRight (World world){
	    ...
	    bodyDef.position.set(700.0f/RATE, 0.0f/RATE);
